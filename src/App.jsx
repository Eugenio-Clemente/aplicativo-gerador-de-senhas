...
function App() {
  ...
  const copyPasswordHandler = (e) => {
    ...
    if (password.trim().length === 0) {
      setModal({
        title: "Erro",
        message: "Não há nada para copiar",
        show: true,
      });
    } else {
      setModal({
        title: "Successo",
        message: "Senha copiada com sucesso para a área de transferência",
        show: true,
      });
    }
  ...
  return (
    <div className="App">
      ...
      <div className="generator">
        <h2 className="generator__title">Gerador de senhas</h2>
        ...
        <form className="generator__form">
          <div className="generator__form-controls">
            ...
            <div className="generator__form-control">
              <label htmlFor="lowercase">Minúsculos</label>
              <input
                checked={isLowercase}
            ...
            <div className="generator__length">
              <h4 className="generator__length-title">Comprimento da senha</h4>
